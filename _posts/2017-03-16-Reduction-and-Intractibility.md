...
Here are some popular $$NPC$$ Problems
...
Now, we solve the problem $$CLIQUE(\bar{G}, \left\vert{V}\right\vert - k)$$, and return $$YES$$ if we have a solution, and $$NO$$ otherwise.
